...
<body class="{' '.join(body_classes)}">
    ...
    def _build_nav(self) -> str:
        """Build the navigation bar using shared component."""
        return build_header('home', self.ctx.generated_at)
    ...
    def _build_footer(self) -> str:
        """Build the footer using shared component."""
        style_info = f"Style: {html.escape(self.design.get('personality', 'modern').title())} | Theme: {html.escape(self.design.get('theme_name', 'Auto-generated'))} | Layout: {self.layout.title()}"
        return build_footer(self.ctx.generated_at, style_info)
